  ...
  return (
    <div id="resume-raw-content" className="w-full h-full flex font-sans bg-slate-50 text-slate-800 relative">
      ...
      <main className="w-[66%] p-8 flex flex-col gap-5 shrink-0 bg-white">
        ...
        {/* Summary Node */}
        {validSummary && (
          <div className="text-[14px] leading-relaxed text-slate-600 mb-2 bg-gradient-to-r from-slate-50 to-white p-4 border-l-4 border-cyan-400 rounded-r-lg whitespace-pre-wrap shadow-sm">
            {validSummary}
          </div>
        )}
